...
template<> bool miller_rabin_det<int128_t>(int128_t num) {
    ...
    return miller_rabin_det_backend<uint128_t, uint256_t>(static_cast<uint128_t>(num));
}
...
template<> bool miller_rabin_det<int256_t>(int256_t num) {
    ...
    return miller_rabin_det_backend<uint256_t, uint512_t>(static_cast<uint256_t>(num));
}
...
template<> bool miller_rabin_det<int512_t>(int512_t num) {
    ...
    return miller_rabin_det_backend<uint512_t, uint1024_t>(static_cast<uint512_t>(num));
}
...
template<> bool miller_rabin_det<int1024_t>(int1024_t num) {
    ...
    return miller_rabin_det_backend<uint1024_t, cpp_int>(static_cast<uint1024_t>(num));
}
